...
public class clientesPOO {
   ...
   // private int ventas;
    ...
    //productos
//    public clientes(int id, String nombre, String descripcion, int cantidad, double precio) {
//        this.id = id;
//        this.nombre = nombre;
...
//    }
    ...
    //sucursales
//    public clientes(int id, String nombre, String correo, String direccion, int telefono) {
//        this.id = id;
//        this.nombre = nombre;
//        this.correo = correo;
...
//    }
    ...
    //vendedores
//    public clientes(int id, String nombre, String genero, int caja, int ventas) {
//        this.id = id;
//        this.nombre = nombre;
//        this.genero = genero;
//        this.caja = caja;
